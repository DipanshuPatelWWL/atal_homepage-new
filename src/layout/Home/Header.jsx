    ...
    <>
      ...
      <header className="hidden lg:block bg-white text-white shadow-xl">
        <div className="flex items-center justify-between px-6 py-2">
          {/* Logo */}
          <img src={logo} className="object-cover h-[80px] w-[240px]" alt="Logo" loading="lazy" decoding="async" />
          {/* Search Bar */}
        ...
        <nav>
          ...
          <ul className="flex items-center justify-center gap-8 py-3 font-semibold text-white bg-black tracking-wide text-base">
            ...
            <Link to="/about"><li className="cursor-pointer hover:text-red-600">ABOUT US</li></Link>
      ...
      <header className="lg:hidden bg-white shadow-xl">
        <div className="flex items-center justify-between px-4 md:py-3">
          <img src={logo} className="h-[100px] w-[100px]" alt="Logo" loading="lazy" decoding="async" />
          <FaBars
            size={24}
      ...
      {/* Mobile Sidebar */}
      <div
        className={`fixed top-0 left-0 h-full w-full bg-black text-white transform ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} transition-transform duration-300 z-50 text-center`}
      >
        ...
        <ul className="flex flex-col gap-4 p-4 text-lg font-semibold">
          <Link to="/" onClick={() => setSidebarOpen(false)} className="cursor-pointer hover:text-red-600">HOME</Link>
          <li className="cursor-pointer hover:text-red-600">ABOUT US</li>
          <li className="cursor-pointer hover:text-red-600">SERVICES</li>
          <li className="cursor-pointer hover:text-red-600">PROMOTION</li>
          <li className="cursor-pointer hover:text-red-600">CATEGORY</li>
          <li className="cursor-pointer hover:text-red-600">CONTACT US</li>
          <Link to="/faq" onClick={() => setSidebarOpen(false)} className="cursor-pointer hover:text-red-600">FAQ</Link>
          <li className="cursor-pointer hover:text-red-600">COLLECTIONS</li>
          <li className="bg-red-600 py-2 px-4 rounded-lg text-center cursor-pointer">BOOK EYE EXAM</li>
        </ul>
      </div>
