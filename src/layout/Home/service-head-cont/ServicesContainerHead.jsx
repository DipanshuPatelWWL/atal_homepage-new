    ...
    return (
        <>
            <div className="relative bg-white rounded-[20px] p-[23px] shadow-white transition-all duration-300 ease-in-out hover:-translate-y-[10px] hover:shadow-xl hover:bg-red-600 hover:text-white group hover:cursor-pointer border-red-600 border-2">
                ...
                <div className="absolute text-[20px] bottom-[2px] right-[5px] bg-black text-white rounded-full p-[10px] shadow-xl hover:translate-x-[3px] hover:-translate-y-[3px] transition-all duration-300 ease-in-out hover:bg-white hover:text-black hover:rotate-[-45deg]">
                    {props.arrow}
                </div>
            </div>
        </>
