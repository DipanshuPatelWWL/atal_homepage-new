            ...
            <div className='flex flex-col justify-center text-center items-center'>
                ...
                <div className='text-xl mb-20 w-150'>
                    ...
                    <div className="border border-gray-600 rounded-md mt-7">
                        <h1 className="text-red-600 text-2xl mt-3">Fill Your Details</h1>
                        ...
                        <div>
                            <button
                                type="submit"
                                className="w-120 border border-gray-300 rounded-md p-2 bg-red-500 text-white mt-3 mb-5 hover:bg-red-700">Book Appointment</button>
                        </div>
